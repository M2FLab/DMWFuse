...
class Expertset(object):
    def __init__(self, num_experts, gates):
        ...
        self._nonzero_indices = torch.nonzero(self._nonzero_mask, as_tuple=False)  
        ...
        self._sample_indices = self._nonzero_indices[:, 0]  # [K]
        self._expert_indices = self._nonzero_indices[:, 1]  # [K]
