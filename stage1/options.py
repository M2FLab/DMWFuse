...
parser.add_argument('--data_file_dir', type=str, default='/media/olmman/sharkE/lunwen/2025.10.2/DMWFuse-main/stage1/data_dir/',  help='path of txt for training set')
